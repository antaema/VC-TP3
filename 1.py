...
class Searcher():
    ...
    def printComponents(self):
        i = 0 
        print "\n****** Components ******"
        for a in self.lcomponents:
            print "Componente  %d: - Area: %d - Diameter: %.2f - Perimeter: %.2f" % (i, a.getArea(), a.getDiameter(), a.getPerimeter())
            i = i +1
    ...
    def updateText(self, comp):
        ...
        if comp > -1:
            ...
            text = text + "\n\nComponente  %d\nArea: %d\nDiameter: %.2f\nPerimeter: %.2f" % (comp, c.getArea(), c.getDiameter(), c.getPerimeter())
...
def main():
    global slthres, gray_img, thresh, a0, s, radio_val, slelmin,bb,f
    sys.setrecursionlimit(100000)

    img = cv2.imread('collored.jpg')
    ...
    slthres = Slider(a1,'Threshold', valmin=0,valmax=255, valinit=0, valfmt= "%3.0f")
